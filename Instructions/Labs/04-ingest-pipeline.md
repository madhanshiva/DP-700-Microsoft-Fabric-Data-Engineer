...
1. Then close the data preview and select **Next (5)**.    
...
1. Select the **Notebook (1)** activity, and then in the pane below the design canvas, set the following properties:
    ...
    - **Settings (1)**:
        ...
        - **Base parameters**: Click on **New (3)** to add a new parameter with the following properties:
            
            | Name | Type | Value |
            | -- | -- | -- |
            | table_name **(4)** | String **(5)** | dbo.new_sales **(6)** |
